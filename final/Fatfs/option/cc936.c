...
{
  WCHAR c;
  uint32_t offset; // W25X16????
  uint8_t GBKH,GBKL; // GBK??????
  uint8_t unigbk[2]; // 
  uint8_t gbkuni[2]; // 
  ...
  else
  {
    if(dir == 0) /* Unicode to GBK */
    {
      switch(src)
      {
      case 0x3001: c = 0xA1A2;break;	   // ????: ? ????
      case 0x300A: c = 0xA1B6;break;     // ????:«
      case 0x300B: c = 0xA1B7;break; 	   //  ????:»
      case 0x201C: c = 0xA1B0;break;	   // ????: “	??????
      case 0x201D: c = 0xA1B1;break;     // ????:”   ??????
      case 0x2606: c = 0xA1EE;break; 	   //  ????:?
      case 0x2605: c = 0xA1EF;break;	   // ????: ?
      case 0x2018: c = 0xA1AE;break;     // ????:‘ ??????
      case 0x2019: c = 0xA1AF;break; 	   //  ????:’??????
      case 0x3010: c = 0xA1BE;break;	   // ????: ?
      case 0x3011: c = 0xA1BF;break;     // ????: ?
      case 0x3016: c = 0xA1BC;break; 	   //  ????:?
      case 0x3017: c = 0xA1BD;break;	   // ????: ?
      case 0x2299: c = 0xA1D1;break;     // ????:?
      case 0x2116: c = 0xA1ED;break; 	   //  ????:?
      case 0x2236: c = 0xA1C3;break;	   // ????: :
      case 0x203B: c = 0xA1F9;break;     // ????:?
      case 0x221E: c = 0xA1DE;break; 	   //  ????:8
      default:
